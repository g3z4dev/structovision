...
export class ViewModel {
    ...
    /**
     * Begins the frame by frame rendering.
     */
    public begin() {
    ...
    private setupPersistenceButtons() {
        // Based on the solution found here: https://www.javaspring.net/blog/create-and-save-a-file-with-javascript/
        ...
        // Based on the solution found here: https://stackoverflow.com/questions/16215771/how-to-open-select-file-dialog-via-js
    ...
    /**
     * Loads the cached structogram and run settings from localStorage.
     */
    public loadCache() {
    ...
    /**
     * Caches the structogram and run settings in localStorage.
     */
    public saveCache() {
    ...
    constructor() {
        ...
        function setupHover(elem: HTMLElement) {
            ...
            elem.addEventListener("mousemove", event => {
                const trkey = elem.dataset["helpTrkey"];
                if(trkey && trkey.length > 0 && hoverHelpElem.classList.contains("hidden")) {
                    hoverHelpElem.classList.remove("hidden");
                    hoverHelpMessageElem.textContent = Translator.getDictionary().translate(elem.dataset["helpTrkey"]!);
                    updatePosition(event);
                }
