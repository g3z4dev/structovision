...
export class HungarianDictionary extends Dictionary {
    ...
    protected override textDictionary = {
        ...
        "control_block_description": "Irányítóblokk: Végrehajt egy állítást",
        "print_block_description": "Kiíróblokk: Kiír egy szöveges értéket",
